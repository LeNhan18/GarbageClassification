# train_model2b.py
# Huấn luyện mô hình phân loại chi tiết các loại rác không tái chế
...
csv_logger = CSVLogger(os.path.join(logs_dir, 'model2b_training.csv'))
...
model.save(os.path.join(models_dir, 'model2b_multiclass_non_recyclable.keras'))
...
with open(os.path.join(logs_dir, 'model2b_evaluation.txt'), 'w') as f:
...
plt.savefig(os.path.join(logs_dir, 'model2b_confusion_matrix.png'))
plt.close()
...
with open(os.path.join(models_dir, 'class_mapping_2b.json'), 'w') as f:
